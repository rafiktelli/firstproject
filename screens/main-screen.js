         ...
         <StatusBar barStyle="dark-content" backgroundColor={colors.lighterGray} /> 
            ...
            <View style={{flexDirection:'row' ,paddingVertical: 20}}>
                ...
                <View style={{ width:150, height:150, backgroundColor: colors.white , borderRadius:0,  marginHorizontal:10, alignItems:'center', justifyContent:'center' }}>
                        ...
                        <Text style={{  paddingTop:20, fontSize:20, fontWeight: '600', color: colors.black, alignItems:'center', justifyContent:'center' }} > Planifier une consultation </Text>
                    </View>
                </TouchableOpacity>   
                <TouchableOpacity onPress={() => navigation.navigate("Surgery") } >
                <View style={{ width:150, height:150, backgroundColor: colors.white , borderRadius:0,  marginHorizontal:10, alignItems:'center', justifyContent:'center', flexDirection:'column' }}>
                        <Image source={require('../assets/surgery.png')} style={{height:50, width:50}} />
                        <Text style={{  paddingTop:20, fontSize:20, fontWeight: '600', color: colors.black,   }} > Planifier une chirurgie </Text>
                    </View>
                </TouchableOpacity>    
            </View>  
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Assign Task") }>
                    <View style={{ width:150, height:150, backgroundColor: colors.white , borderRadius:0,  marginHorizontal:10, alignItems:'center', justifyContent:'center',  }}>
                        ...
                        <View style={{alignItems:'center', justifyContent:'center',}}>
                            <Text style={{  paddingTop:20, fontSize:20, fontWeight: '600', color: colors.black,   }} > Attribuer des tâches </Text>
                        </View>
                    </View> 
                </TouchableOpacity>         
                ...
                <View style={{ width:150, height:150, backgroundColor: colors.white , borderRadius:0,  marginHorizontal:10, alignItems:'center', justifyContent:'center' }}>
                        ...
                        <Text style={{  paddingTop:20, fontSize:20, fontWeight: '600', color: colors.black, }} > Gérer le personnel  </Text>
                    </View>
                </TouchableOpacity>    
